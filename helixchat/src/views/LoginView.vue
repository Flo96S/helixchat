    ...
    <div class="w-full max-w-xs">
      <div class="bg-gray-800 shadow-md rounded px-8 pt-6 pb-4 mb-4">
        <div class="mb-4">
          ...
          <input id="username" v-model="username" name="username" type="text" placeholder="Username - RZ-Id"
        ...
        <div class="text-center">
          <button @click="goToRegister" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded"
